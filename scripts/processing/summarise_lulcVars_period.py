...
def main():
    ...
    lulc_fp = '../../data/processed/lulc_data/MBlanduse_percArea_subsetLULC_grid{}_{}.csv'.format(grid_id, '{}')
    lulc_cols = ['natural', 'anthropic', '4', '3', '12', '11', '15', '18']
    
    output_fp = '../../data/processed/summary_tables/{}_year_periods/lulc_percArea_allPeriods.csv'.format(n_years)
