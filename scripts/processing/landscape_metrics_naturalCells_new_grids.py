...
Re-categorization:
    natural_cats = [3,4,5,6,49,11,12,32,29,13]
    anthropic_flammable_cats = [15, 19,39,20,40,62,41,36,46,47,35,48,9,21]
...
def main():
    ...
    grid_id = input("Grid to work on: <size><units>\n")
    print('------------------------------------------------------------------')
    print('')
    ...
    lulc_fp = '../../data/raw/MBlulc/mapbiomas-brazil-collection-80-{}.tif'
    
    # Output filepath
    output_fp = '../../data/processed/landscape_metrics/MBlulc_landscapeCellMetrics_grid{}_{}.csv'.format(grid_id, '{}')
