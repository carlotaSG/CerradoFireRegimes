...
if __name__ == '__main__':
    ...
    # Input files
    # pop_dens_fp = '../../data_new_grids/processed/BRA_population/municipalities_pop_{}.csv'
    pop_dens_fp = '../../data_new_grids/processed/livestock/municipalities_livestock_{}.csv'
    frac_area_fp = '../../data_new_grids/tools/municipalities_areaFraction_grid{}.csv'.format(grid_id)
    
    # Output file
    # out_fp = '../../data_new_grids/processed/summary_tables/annual/population_density_grid{}_{}.csv'
    out_fp = '../../data_new_grids/processed/summary_tables/annual/livestock_density_grid{}_{}.csv'
    ...
    dens_col = 'anim_density' # 
    # dens_col = 'pop_density'
    
    # Column to store the area weighted density
    areaw_dens = 'areaw_dens' # 
    # areaw_dens = 'areaw_popdensity'
