...
def four_periods():
    ...
    cluster_structure = { 
        'period1' : {
            574  : {'clust_id' : 'A', 'clust_col' : colors['A']},
            936  : {'clust_id' : 'B', 'clust_col' : colors['B']},
            3872 : {'clust_id' : 'C', 'clust_col' : colors['C']},
            5969 : {'clust_id' : 'D', 'clust_col' : colors['D']},
            6337 : {'clust_id' : 'E', 'clust_col' : colors['E']},
            5485 : {'clust_id' : 'F', 'clust_col' : colors['F']},
            4347 : {'clust_id' : 'G', 'clust_col' : colors['G']}                         # Until here these cells serve as reference for all periods
            },
        'period2' : {
        ...
        'period4' : {
            395  : {'clust_id' : 'A', 'clust_col' : colors['A']},
            847  : {'clust_id' : 'B', 'clust_col' : colors['B']},
            3328 : {'clust_id' : 'C', 'clust_col' : colors['C']},
            5882 : {'clust_id' : 'D', 'clust_col' : colors['D']},
            2120 : {'clust_id' : 'E', 'clust_col' : colors['E']},
            3282 : {'clust_id' : 'F', 'clust_col' : colors['F']},
            5579 : {'clust_id' : 'G', 'clust_col' : colors['G']}
            }
        }
